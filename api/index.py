...
.video-grid{
  ...
  gap:24px;max-width:1100px;margin:24px auto 0;
...
.video-embed iframe{
  position:absolute;top:0;left:0;width:100%;height:100%;border:0;border-radius:16px;
}
...
.nl-card:hover{border-color:var(--accent);transform:translateX(6px)}
.nl-card .nl-icon{
  font-size:1.4rem;flex-shrink:0;
  width:44px;height:44px;display:flex;align-items:center;justify-content:center;
  background:rgba(255,103,25,.12);border-radius:12px;color:#FF6719;
}
.nl-card .nl-title{font-size:.98rem;font-weight:600;line-height:1.4}
.nl-card .nl-arrow{margin-left:auto;color:var(--accent);font-size:1.1rem;flex-shrink:0}
</style>
</head>
<body>
...
<!-- VIDEOS -->
<section class="h-section" id="videos">
  <p class="section-label">Video Content</p>
  <h2>Watch &amp; Learn</h2>
  <p class="subtitle">Technical tutorials and storytelling insights</p>
  <div class="video-grid">
    <div class="video-embed">
      <iframe src="https://www.youtube.com/embed/x-PyeOhqXi0"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowfullscreen></iframe>
    </div>
    <div class="video-embed">
      <iframe src="https://www.youtube.com/embed/84oDAPn7kls"
              title="YouTube video player"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowfullscreen></iframe>
    </div>
...
<section class="newsletter-section" id="newsletter">
  ...
  <p style="font-size:.9rem;max-width:580px;margin-top:4px">Lessons, frameworks, and behind-the-scenes insights every week to help you write technical content that actually makes a difference.</p>

  <div class="nl-cards">
    {% for nl in newsletters %}
    <a class="nl-card" href="{{ nl.url }}" target="_blank" rel="noopener">
  ...
  <a class="cta" href="https://techwithpraisejames.substack.com/" target="_blank"
     style="background:linear-gradient(135deg,#ff6719,#ff6b6b);margin-top:24px">
    Subscribe to Tech &amp; Storytelling &nearr;
  </a>

  <div style="width:100%;max-width:640px;border-top:1px solid rgba(255,255,255,.06);padding-top:32px;margin-top:16px">
    <p style="color:var(--text2);font-size:.85rem;margin-bottom:16px;text-align:left">Search all articles</p>
    <div class="search-wrap">
      <span class="search-icon">&#128269;</span>
      <input type="text" id="searchInput" placeholder="Search by topic, keyword, or technology..."
             autocomplete="off">
    </div>
